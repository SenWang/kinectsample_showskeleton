...
namespace SoulSolutions.Kinect.Controls.Skeleton
{
    ...
    public class SkeletonControl : Control
    {
        ...
        private Microsoft.Kinect.Skeleton skeletonData;
        ...
        public Microsoft.Kinect.Skeleton SkeletonData
        {
            ...
            set
            {
                ...
                skeletonData = value;
                SetUiPosition(headUi, skeletonData.Joints[JointType.Head]);
                SetUiPosition(handLeftUi, skeletonData.Joints[JointType.HandLeft]);
                SetUiPosition(handRightUi, skeletonData.Joints[JointType.HandRight]);
                SetUiPosition(hipCenterUi, skeletonData.Joints[JointType.HipCenter]);
                SetUiPosition(footRightUi, skeletonData.Joints[JointType.FootRight]);
                SetUiPosition(footLeftUi, skeletonData.Joints[JointType.FootLeft]);
                SetUiPosition(ankleLeftUi, skeletonData.Joints[JointType.AnkleLeft]);
                SetUiPosition(ankleRightUi, skeletonData.Joints[JointType.AnkleRight]);
                SetUiPosition(elbowLeftUi, skeletonData.Joints[JointType.ElbowLeft]);
                SetUiPosition(elbowRightUi, skeletonData.Joints[JointType.ElbowRight]);
                SetUiPosition(hipLeftUi, skeletonData.Joints[JointType.HipLeft]);
                SetUiPosition(hipRightUi, skeletonData.Joints[JointType.HipRight]);
                SetUiPosition(kneeLeftUi, skeletonData.Joints[JointType.KneeLeft]);
                SetUiPosition(kneeRightUi, skeletonData.Joints[JointType.KneeRight]);
                SetUiPosition(shoulderCenterUi, skeletonData.Joints[JointType.ShoulderCenter]);
                SetUiPosition(shoulderLeftUi, skeletonData.Joints[JointType.ShoulderLeft]);
                SetUiPosition(shoulderRightUi, skeletonData.Joints[JointType.ShoulderRight]);
                SetUiPosition(spineUi, skeletonData.Joints[JointType.Spine]);
                SetUiPosition(wristLeftUi, skeletonData.Joints[JointType.WristLeft]);
                SetUiPosition(wristRightUi, skeletonData.Joints[JointType.WristRight]);
            }
        }
        ...
        public bool Jump
        {
            get { return SkeletonData.Joints[JointType.FootLeft].Position.Y > -0.7 && SkeletonData.Joints[JointType.FootRight].Position.Y > -0.7; }
        }

        public bool LeftArmOut
        {
            get { return ((SkeletonData.Joints[JointType.HandLeft].Position.X - SkeletonData.Joints[JointType.ShoulderLeft].Position.X) < -0.5); }
        }

        public bool RightArmOut
        {
            get { return ((SkeletonData.Joints[JointType.HandRight].Position.X - SkeletonData.Joints[JointType.ShoulderRight].Position.X) > 0.5); }
        }

        public bool RightArmUp
        {
            get { return ((SkeletonData.Joints[JointType.HandRight].Position.Y - SkeletonData.Joints[JointType.Head].Position.Y) > 0); }
        }

        public bool LeftArmUp
        {
            get { return ((SkeletonData.Joints[JointType.HandLeft].Position.Y - SkeletonData.Joints[JointType.Head].Position.Y) > 0); }
        }

        public bool Crouched
        {
            get { return (Math.Abs(SkeletonData.Joints[JointType.FootLeft].Position.Y - SkeletonData.Joints[JointType.HandLeft].Position.Y) < 0.2); }
        }
        ...
        public bool HandsTogether
        {
            get
            {
                return (Math.Abs(SkeletonData.Joints[JointType.HandRight].Position.Y - SkeletonData.Joints[JointType.HandLeft].Position.Y) +
                        Math.Abs(SkeletonData.Joints[JointType.HandRight].Position.X - SkeletonData.Joints[JointType.HandLeft].Position.X) < 0.3);
            }
        }
